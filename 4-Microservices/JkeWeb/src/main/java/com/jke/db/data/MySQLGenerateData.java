...
public class MySQLGenerateData extends GenerateData {
    ...
    protected String getTransactionTableColumnString() {
        return " (TransactionID INTEGER  AUTO_INCREMENT , Type VARCHAR(30), AccountNumber INTEGER, Source VARCHAR(50), Amount DOUBLE, PostBalance DOUBLE, Date VARCHAR(20), ContributionID INTEGER, PRIMARY KEY (TransactionID))";
    }
    ...
    protected String getAccountTableColumnString() {
        return "(AccountNumber INTEGER  AUTO_INCREMENT, Balance DOUBLE, Dividends DOUBLE, DividendsETD DOUBLE, Contributions DOUBLE, ContributionsETD DOUBLE, UserName varchar(40) NOT NULL, AccountType VARCHAR(30) NOT NULL, PRIMARY KEY (AccountNumber), UNIQUE(UserName, AccountType))";
    }

    protected String getContributionsTableColumnString() {
        return "(ContributionID INTEGER AUTO_INCREMENT, AccountNumber INTEGER, Organization VARCHAR(50), Percentage DOUBLE, Date VARCHAR(20), PRIMARY KEY (ContributionID))";
    }

    @Override
    protected String getInterestRateTableColumnString() {
        return " (id INTEGER  NOT NULL AUTO_INCREMENT , category VARCHAR(40), tenure VARCHAR(40), interestRateRegular VARCHAR(40), interestRateSenior VARCHAR(40), comments VARCHAR(40), PRIMARY KEY (id))";
    }

    protected String getNewAccountTableColumnString() {
        return "(id INTEGER AUTO_INCREMENT, FirstName varchar(40), LastName varchar(40), UserName varchar(40), Password varchar(40), CompanyName varchar(100), HomeAddress varchar(100), OfficeAddress varchar(100), MobileNo varchar(15),  AlternateMobileNo varchar(15), EmailId varchar(40), AccountType varchar(5), KYCDocuments varchar(40), Status varchar(40), Remarks varchar(40),  Roles varchar(100), PRIMARY KEY (id))";
    }
}
