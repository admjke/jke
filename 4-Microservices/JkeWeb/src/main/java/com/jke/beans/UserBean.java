...
public class UserBean {
    ...
    public UserBean(String userName, String firstName, String lastName, String password, String companyName, String homeAddress, String officeAddress, String mobileNo, String alternateMobileNo, String emailId, String accountType, String kycDocuments, String status, String remarks, String roles) {
        this.userName = userName;
        this.firstName = firstName;
        this.lastName = lastName;
    ...
    public void deserializeFromJson(Reader r) throws IOException {
        ...
        setUserName((String) userObj.get("first"));
