...
public class TransactionLogic {
	...
	public List<TransactionBean> getTransactionHistory(UserBean user, AccountTypeBean acctType) {
        ...
        System.out.println("getTransactionHistory user :" + user);
        System.out.println("getTransactionHistory acctType :" + acctType);
		System.out.println("getTransactionHistory AccountNumber :" + accountNum);
