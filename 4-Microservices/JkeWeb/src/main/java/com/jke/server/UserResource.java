...
public class UserResource extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("user doGet Test 1 ---->");
		...
		System.out.println("user doGet Test 1 ----> userId :" + userId);
		System.out.println("user doGet Test 1 ----> action :" + action);

		
		if (paths.isEmpty() || userId == null) {
			System.out.println("user doGet Test 2 ----> " );
		...
		if (action == null) {
			System.out.println("user doGet Test 3 ----> " );
			...
			System.out.println("user doGet Test 3.result ----> " + user.toJson());

		} else if (action.equals("accounts")) {
			System.out.println("user doGet Test 4 ----> " );
		...
		System.out.println("user doGet Test 5 ----> " );
	...
	throws ServletException, IOException {
		...
		if (userId == null && action == null) {
			...
			try {
				...
				user.setPassword((String) obj.get("pwd"));
				loader.pushUserBean(user);
